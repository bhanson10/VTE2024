...
MDL = "results";
DIR = {"c", "analytical", "monte"}; 
TU = 1; 
names = {'c','python (analytical)', 'python (Monte)'};
time_unit = '(TU)';

f = {}; 
for i=1:length(names)
    f{end+1} = fopen("./" + MDL + "/" + DIR{i} + "/runtime.txt", 'r');
end
...
title(tiles, "PCR3BP Runtime Comparison", 'FontWeight', 'Bold','FontName', 'Times','FontSize', 18);
%% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                FUNCTIONS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
